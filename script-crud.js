...
const btnRemoverComcluidas = document.getElementById('btn-remover-concluidas')
...
function criarElementoTarefa(tarefa) {
    ...
    if(tarefa.completa){
        ...
        if(tarefaSelecionada == tarefa){
            paragrafoDaDescricaoTarefa.textContent = null
...
btnRemoverComcluidas.onclick = () => removerTarefas(true)
